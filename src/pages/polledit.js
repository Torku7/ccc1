...
import "./ccc_polledit.css";
import closeIcon from "./close.png"; // close.png 파일의 경로에 맞게 수정해주세요.
    ...
    <div className="popup show-popup" id="popup">
      ...
      <div className="content-title">
        <div className="title-container">
          <h1>선호 장르 조사</h1>
          <button className="close-btn" onClick={() => document.getElementById("popup").classList.remove("show-popup")}>
